...
//static
:tasksdir: _tasks/
:solution-pattern-title: Connecting applications using asynchronous messaging
...
* Order Entry System - Provides a RESTful API and a user interface to create order messages for customers.
